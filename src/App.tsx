...
import type { AppState, SkillKey, WeightageTotals } from './types';
...
const downloadJson = (data: AppState, filename: string): void => {
...
const writeStoredState = (state: AppState): void => {
    try {
...
function App() {
    ...
    const [applyToCoverage, setApplyToCoverage] = useState<boolean>(true);
    ...
    const activeSkill = useMemo((): SkillKey => {
        const skillMap: Record<string, SkillKey> = {
            speaking: 'speaking',
            writing: 'writing',
            reading: 'reading',
            listening: 'listening',
    ...
    const toggleCoverage = (questionTypeId: string) => {
    ...
    const toggleSessionItem = (questionTypeId: string) => {
